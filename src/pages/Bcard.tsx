    ...
    return ( 
        <>
         { userData?.checked || userData?.isAdmin ?
                                ...
                                >
                                <button className="btn btn-link text-secondary">Update user details</button>
                                </Link> : <span></span>
        ...
        <input 
                    ...
                    /> 
        <div>           
          <button className="btn btn-sm btn-outline-secondary mx-3" onClick={handleClick}>change display</button>
        </div> 
        <div className={!displayMode ? "d-flex" : ""}>
                {
